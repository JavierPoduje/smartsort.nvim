...
M.any_backup = function(predicate)
...
M.curry_backup = function(arity, func)
...
M.filter_backup = function(predicate)
    return function(tbl)
        local result = {}
